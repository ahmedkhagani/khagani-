...
class disease{
  ...
  disease(this.name,this.sym1,this.sym2,this.sym3,this.sym4,this.rf1,this.rf2,this.rf3,this.rf4,this.chief);
  // this line is important
  }
void Disease({String chief})async {
